package tech.olbri.android.timedurationpicker;
...
import tech.olbri.android.timedurationpicker.R;
...
public class TimeDurationPicker extends FrameLayout {
    ...
    public TimeDurationPicker(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            applyTextAppearance(attributes, R.styleable.TimeDurationPicker_textAppearanceDisplay, displayViews);
            applyTextAppearance(attributes, R.styleable.TimeDurationPicker_textAppearanceButton, numPadButtons);
            applyTextAppearance(attributes, R.styleable.TimeDurationPicker_textAppearanceUnit, unitLabelViews);
